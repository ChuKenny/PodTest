...
typedef enum {
	/** No error. */
	SGKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	SGKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	SGKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	SGKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	SGKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	SGKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	SGKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	SGKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	SGKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	SGKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	SGKeychainErrorFailedToDecode = errSecDecode
} SGKeychainErrorCode;

extern NSString *const kSGKeychainErrorDomain;

/** Account name. */
extern NSString *const kSGKeychainAccountKey;
 ...
 */
extern NSString *const kSGKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kSGKeychainClaSGKey;

/** Item description. */
extern NSString *const kSGKeychainDescriptionKey;

/** Item label. */
extern NSString *const kSGKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kSGKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kSGKeychainWhereKey;
...
/**
 ...
 SGKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
@interface SGPKeychain : NSObject
...
/**
 ...
 See the `NSString` constants declared in SGKeychain.h for a list of keys that can be used when accessing the
